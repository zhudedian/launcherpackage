...
public class FastKeyActivity extends AppCompatActivity implements View.OnFocusChangeListener, View.OnClickListener, View.OnLongClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        baseview = LayoutInflater.from(this).inflate(R.layout.activity_fast_key,null);
...
//		selecter = (FlyImageView) findViewById(R.id.key_selector);
        ...
        keys[10].setKeycode(KeyEvent.KEYCODE_BOOKMARK);
        keys[11].setKeycode(KeyEvent.KEYCODE_CAPTIONS);
...
//		},300);
    ...
    public List<PackageHolder> getcurrentPhs(){
        List<PackageHolder> phs = new ArrayList<>();
    ...
    public void showAppSelectWindow(final KeyItem v) {
        List<PackageHolder> phs  = getcurrentPhs();
        ...
        appSelectWindow.setOnAppSelectListener(new AppSelectWindow.OnAppSelectListener() {
            ...
            public void onAppSelected(PackageHolder holder) {
                if(!holder.getPackageName().equals("add")) {
                    v.setApplication(ApplicationUtil.doApplication(FastKeyActivity.this, holder.getPackageName()));
